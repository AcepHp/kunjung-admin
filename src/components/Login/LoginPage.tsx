            ...
            <div className="w-full max-w-5xl bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-10">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <div className="mb-3">
                            {/* Using standard img tag to bypass Next.js Image optimization issues */}
                            <img
                    ...
                    <form className="space-y-5" onSubmit={handleLogin}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full rounded-lg bg-[#7A3E2C] hover:bg-[#693424] text-white text-sm font-medium py-2.5 transition disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {loading ? (
